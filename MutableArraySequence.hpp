...
template<typename T>
ArraySequence<T>* MutableArraySequence<T>::CreateFromArray(T* items, int count) const
{
...
template<typename T>
MutableArraySequence<T>::MutableArraySequence(const DynamicArray<T>& dynamicArray) : ArraySequence<T>(dynamicArray) { }
